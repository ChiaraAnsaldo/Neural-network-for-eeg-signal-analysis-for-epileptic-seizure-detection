...
def DeepConvNet(nb_classes, Chans = 64, Samples = 256,
    ...
    block2       = Activation('elu')(block2)
    block2       = AveragePooling2D(pool_size=(1, 2), strides=(1, 2))(block2)
    ...
    block3       = AveragePooling2D(pool_size=(1, 2), strides=(1, 2))(block3)
    ...
    block4       = AveragePooling2D(pool_size=(1, 2), strides=(1, 2))(block4)
